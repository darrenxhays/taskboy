...
BROKER_SOCKET = os.environ.get("TASKBOY_BROKER_SOCKET", "local/broker.sock")
REVIEWER_BROKER_SOCKET = os.environ.get("TASKBOY_REVIEWER_BROKER_SOCKET", "local/broker-reviewer.sock")
GIT_CRED_HELPER = os.environ.get("TASKBOY_GIT_CRED_HELPER", str(assets.GIT_CRED_HELPER))
